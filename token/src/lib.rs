use near_sdk::{AccountId, Balance, env, ext_contract, Promise, StorageUsage, near_bindgen};
use borsh::{self, BorshDeserialize, BorshSerialize};
use near_sdk::collections::UnorderedMap;
use near_sdk::json_types::U128;

const YOTTA_MULTIPLIER: Balance = 1000000000000000000000000;
const STORAGE_PRICE_PER_BYTE: Balance = YOTTA_MULTIPLIER / 10000;
